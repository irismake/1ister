      ...
      builder: (context, provider, child) {
        ...
        return Padding(
          ...
          child: ListView.separated(
            ...
            itemCount: followerCount,
            itemBuilder: (context, index) {
              // if (usersFollowerLists.isEmpty) {
              //   return Center(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${utf8.decode(usersFollowerLists[index].name.runes.toList())}',
                                style: TextStyle(
                              ...
                              Text(
                                '${utf8.decode(usersFollowerLists[index].bio.runes.toList())}',
                                style: TextStyle(
